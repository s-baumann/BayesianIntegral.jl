...
# """
# function bayesian_integral_gaussian_exponential(X::AbstractArray{T,2}, f::AbstractArray{R,1} , prob_means::AbstractArray{U,1}, covar::Symmetric, cov_func_parameters::GaussianKernelHyperparameters, noise::Real = 0.0 )  where T<:Real where R<:Real where U<:Real
...
"""
    integrate(modl::KrigingModel, prob_means::AbstractArray{U,1}, covar::Symmetric) where U<:Real
...
the pdf which is multivariate gaussian.
"""
function integrate(modl::KrigingModel, prob_means::AbstractArray{U,1}, covar::Symmetric) where U<:Real
